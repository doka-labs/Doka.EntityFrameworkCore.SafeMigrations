...
composite-key catalog-matching defects. The next stable source adds a separately
packaged SQLite adapter with transactional, model-owned rebuilds. These releases follow changed
