...
observed publication-assurance gap. The 10.0.2 maintenance line responded to
Doka 10.2.0's ownership-aware connection invariants and to a confirmed
generated-migration namespace defect. Current source additionally qualifies
Doka 10.3.0's typed migration-operation metadata and repairs observed legacy
convergence defects. These are changed dependency conditions and correctness
repairs, not an incomplete initial feature line.
