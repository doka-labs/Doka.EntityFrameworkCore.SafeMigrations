...
- [Doka 10.1.0 scoped-command cleanup contract](https://github.com/doka-labs/Doka.EntityFrameworkCore.MySql/blob/v10.1.0/docs/migration-operation-handlers.md) (primary source; retrieved 2026-08-28)
